...
Note: Every single point MUST start with "• " followed by an emoji and a space. Do not use numbered lists. Alaways maintain this exact format for ALL points in ALL sections.
