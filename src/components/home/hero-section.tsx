    ...
    <section className="relative mx-auto flex flex-col z-0 items-center justify-center py-16 sm:py-20 lg:pb-28 transition-all animate-in lg:px-12 max-w-7xl">
      ...
      <h1 className="font-bold py-6 text-center">
        ...
        <span className="relative inline-block">
          ...
          <span
            className="absolute inset-0 bg-rose-200/50 -rotate-2 rounded-lg tranform -skew-y-1"
            aria-hidden="true"
          ></span>
        </span>{" "}
        summaries
      ...
      <h2 className="text-lg sm:text-xl lg:text-2xl text-center px-4 lg:px-0 lg:max-w-4xl text-gray-600">
        Get a beautiful summary reel if the document in seconds.
      </h2>
      <div>
        <Button
          variant={"link"}
